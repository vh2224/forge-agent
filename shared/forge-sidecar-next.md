...
> into every orchestrator turn. Read ONLY when the resolver returns `DISPATCH_ENGINE != claude`
> for a routable unit. Canonical contract: `shared/forge-dispatch.md § Worker Engine Routing`.
